...
<div id="preview" ><img src="filed.png" width="80px"/></div><br>
...
<? php 
$ img = $ _FILES [ "image" ] [ "name" ] lưu trữ tên tệp gốc từ máy khách
$ tmp = $ _FILES [ "image" ] [ "tmp_name" ] lưu trữ tên của tệp tạm thời được chỉ định
$ errorimg = $ _FILES [ "image" ] [ "error" ] lưu trữ bất kỳ mã lỗi nào do quá trình chuyển
?>
